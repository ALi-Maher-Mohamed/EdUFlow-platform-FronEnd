...
export default function InstructorDashboard() {
  ...
  const handleCreateCourse = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setNewCourse({ title: '', description: '', category: 'Web Development', price: 0, thumbnail: '' });
    } catch (error: any) {
  ...
  const totalStudents = courses.reduce((acc, c) => acc + (c as any).studentsCount || 0, 0);
  const totalRevenue = courses.reduce((acc, c) => acc + ((c as any).studentsCount || 0) * c.price, 0);
      ...
      <Tabs defaultValue="courses" className="w-full">
        ...
        <TabsContent value="courses">
          {courses.length > 0 ? (
                    ...
                    <div className="flex-1 p-6 flex flex-col justify-between">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
                        <div className="flex items-center gap-2 text-sm">
                          ...
                          <span className="font-semibold">{(course as any).studentsCount || 0}</span>
            ...
            <div className="text-center py-20 bg-muted/20 rounded-2xl border-2 border-dashed">
              ...
              <p className="text-muted-foreground mb-6">Start sharing your knowledge with the world.</p>
              <Button onClick={() => setIsDialogOpen(true)}>Create Your First Course</Button>
            </div>
          )}
        </TabsContent>
        ...
        <TabsContent value="stats">
          <Card className="p-12 text-center bg-muted/30 border-dashed">
            ...
            <p className="text-muted-foreground">Detailed insights into your course performance will appear here.</p>
          </Card>
        </TabsContent>
      </Tabs>
    </div>
